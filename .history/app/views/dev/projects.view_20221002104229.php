            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-one active form-step">
                    ...
                    <div>
                        ...
                        <textarea  onclick="textclick()" style="<?= $errors['description']?  "border: 1px solid var(--color-danger);" : ""?>" id="description" name="description" placeholder="brief description of application"><?= set_value('primary_subject')?></textarea>
