      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-overview" id="profile-overview-tab">Overview</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit" id="profile-edit-tab">Edit Profile</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings" id="profile-settings-tab">Settings</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password" id="profile-change-password-tab">Change Password</button>
            </li>
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade profile-settings-tab pt-3" id="profile-settings">
...
<style>
  ...
  <script>
    ...
    var tabid = sessionStorage.getItem("tabid") ? sessionStorage.getItem("tabid"): sessionStorage.setItem("tabid", "profile-overview-tab");
