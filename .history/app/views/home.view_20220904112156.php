...
<!--=============== HOME ===============-->
  <section class="home" id="home">
      <div class="container">
          ...
          <div class="intro">
              <!--avatar image-->
              <img src="assets/img/avatar-1.svg" alt="Dennis">
              <!--info--->
              ...
              <!--button-->
              <div>
                  <a href="#" class="hire-me btn btn-default">Hire me</a>
              </div>
        ...
        <div class="row">
            ...
            <div class="service-item padd-15">
                <div class="service-item-inner" style="background: rgb(38,135,133);">
                    <img width="85px" height="75px" src="assets/img/service-3.png" alt="">
        ...
        <div class="row">
           ...
           <div class="contact-box padd-15">
            <div class="contact-data">
                ...
                <!--contact information-->
                <div class="contact-information">
                    <h3 class="contact-subtitle">Email us for instant support</h3>
                    <span class="contact-description">
                        <i class="lni lni-phone contact-icon"></i>
                        karanikateeti@gmail.com
                    </span>
                </div>
                </div>
           </div>
           ...
           <form action="" class="contact-form padd-15">
                <div class="contact-inputs">
                    ...
                    <div class="contact-content contact-area">
                        <textarea type="text" cols="30" rows="10" class="contact-input "></textarea>
...
<?php $this->view("includes/customize")?>
