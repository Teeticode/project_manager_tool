        ...
        <form method="post">
            <div class="form-one active form-step">
                ...
                <div class="grouping">
                    ...
                    <input type="number" style="width: 100% !important;" class="js-profile-phone" name="phone" id="">
                    </div>
                ...
                <div class="birth">
                    ...
                    <div class="">
                        <input type="date" class="js-profile-bday" value="<?=set_value(Auth::getbday())?>" name="bday" id="bday">
                    </div>
                </div>
