    ...
    <div class="container">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>New Here?</h3>
                    <p>Login and get access premium projects where you can earn money</p>
                    <a href="<?=ROOT?>/developer/signup" class="btn transparent" id="sign-up-btn">For Developers</a>
                    
                </div>
                <div class="content">
                <a href="<?=ROOT?>/client/signup" class="btn transparent" id="sign-in-btn">For Clients</a>
                </div>
