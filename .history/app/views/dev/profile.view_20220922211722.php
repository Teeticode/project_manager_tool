        ...
        <form method="post">
            <div class="form-one active form-step">
                ...
                <div>
                    ...
                    <input type="text" class="js-profile-fname" id="fname" name="fname" placeholder="e.g. John">
                </div>
                <div>
                    <label for="lname">Last Name</label>
                    <input type="text" id="lname" class="js-profile-lname" name="lname" placeholder="e.g. Doe">
                </div>
                <div class="grouping">
                    <label for="country">Country</label>
                    <!-- country codes (ISO 3166) and Dial codes. -->
                    <div class="country-num">
                    <select style="width: 80px; height: 40px;" class="js-profile-country" name="country" id="">
                    ...
                    <input type="number" value="<?=set_value(Auth::getphone())?>" style="width: 100% !important;" class="js-profile-phone" name="phone" id="">
                    </div>
                    
                </div>
                <div>
                    <label for="lname">About</label>
                    <textarea name="about" class="js-profile-about" value=""><?=esc(Auth::getabout())?></textarea>
                </div>
                <div>
                    <label for="email">Email</label>
                    <input type="email" class="js-profile-email" value="<?=esc(Auth::getemail())?>" placeholder="e.g john@gmail.com">
                </div>
                <div class="birth">
                    <label for="bday">Date of Birth</label>
                    <div class="">
                        <input type="date" class="js-profile-bday" value="<?=esc(Auth::getbday())?>" name="bday" id="bday">
                    </div>
                </div>
