            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-one active form-step">
                    ...
                    <div>
                        ...
                        <textarea style="<?= $errors['primary_subject']?  "border: 1px solid var(--color-danger);" : ""?>" id="title" name="primary_subject" placeholder="brief description of application"><?= set_value('primary_subject')?></textarea>
