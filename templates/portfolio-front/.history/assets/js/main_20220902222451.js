     ...
     /** * for(let i=0; i<totalbtns; i++){
      ...
      btns.forEach(btn=>{
        btn.addEventListener('click', function(){
          //  forms.querySelector(".hide").classList.remove("hide")
            console.log(forms)
            
            const validateFilter = this.getAttribute("data-filter");
            console.log(validateFilter);
            console.log(forms)
            const formlength = forms.length
            console.log(formlength)
            forms.forEach(f=>{
                f.querySelector(".hide").classList.remove("hide")
                if(validateFilter === f.getAttribute("data-category")){
