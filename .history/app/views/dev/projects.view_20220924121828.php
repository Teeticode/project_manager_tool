        ...
        <div class="form-box">
            ...
            <form method="post">
                <div class="form-one active form-step">
                    ...
                    <button type="button" style="display:flex; align-items:center; justify-content:center; color: var(--color-dark); border-radius:10px; width:100px; height:50px; padding:14px; background-color: lightgray; font-size:20px;" class="cust_inp">+</button>
