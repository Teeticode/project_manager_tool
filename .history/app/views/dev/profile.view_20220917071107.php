      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('id'))" class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview" id="profile-overview">Overview</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit" id="profile-edit">Edit Profile</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings" id="profile-settings">Settings</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password" id="profile-change-password">Change Password</button>
            </li>
...
<style>
  ...
  <script>
    ...
    function show_tab(tab_name){   
      const someTabTriggerEl = document.getElementById(tab_name);
      const tabn = new  .Tab(someTabTriggerEl);
    ...
    window.onload = function(){
      tab = sessionStorage.getItem("tab") ? sessionStorage.getItem("tab"): "#profile-overview";
      show_tab(tab);
    }
  </script>
