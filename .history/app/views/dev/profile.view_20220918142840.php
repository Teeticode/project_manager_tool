            ...
            <div class="tab-pane fade profile-edit-tab pt-3" id="profile-edit">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="address" type="text" class="js-error-email form-control" id="Address" value="<?=set_value('address',$row->address)?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="phone" type="tel" class="js-error-email form-control" id="phoneno" value="<?=set_value(00, $row->phone)?>" onclick="set_t()">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="email" type="email" class="js-error-email form-control" id="Email" value="<?=set_value('email@gmail.com',$row->email)?>">
                  </div>
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="github" type="text" class="fjs-error-email orm-control" id="Github" value="<?=set_value('https://github.com/#', $row->github)?>">
                  </div>
