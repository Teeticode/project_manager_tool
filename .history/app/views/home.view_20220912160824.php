...
<!--=============== HOME ===============-->
  <section class="home" id="home">
      <div class="container">
      <?php if(message()):?>
                    <div class="message"><?=message('', $erase=true)?>
                </div>
                <?php endif;?>
          <!--intro-->
          <div class="intro">
              ...
              <div>
                ...
                <?php if(!Auth::logged_in()):?>
                    <a href='<?=ROOT?>/client/login' _blank='true' class='hire-me btn btn-default'>Hire me</a>
                <?php else:?>
                    <?php if(Auth::is_client()):?>
                        <a href='<?=ROOT?>/client/dashboard' _blank='true' class='hire-me btn btn-default'>Client Portal</a>
                    <?php endif;?>
                    <?php if(Auth::is_dev()):?>
                        <a href='<?=ROOT?>/developer/dashboard' _blank='true' class='hire-me btn btn-default'>Dev Portal</a>
                    <?php endif;?>
                    <?php if(Auth::is_admin()):?>
                        <a href='<?=ROOT?>/admin' _blank='true' class='hire-me btn btn-default'>Admin Portal</a>
                    <?php endif;?>
...
<section class="services section" id="services">
    <div class="container">
        ...
        <div class="text padd-15">
           <p>Looking for a custom job? <a href="<?=ROOT?>/developer/login">Click here</a> to join community! 👋</p> 
        </div>
    </div>
</section>
<!--=============== Experience ===============-->
