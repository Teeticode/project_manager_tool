              ...
              <form method="post">
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <div class="d-flex">
                      <img style="width:200px; max-width:200px; height:200px; flex:2; object-fit:cover;" class="js-image-preview" src="<?=ROOT?>/nice-admin/assets/img/profile-img.jpg" alt="Profile">
                ...
                <div class="text-center">
                  <a href="<?=ROOT?>/developer/">    
                    <button type="button" class="btn btn-primary float-end space-between">Back</button>
                  </a>
