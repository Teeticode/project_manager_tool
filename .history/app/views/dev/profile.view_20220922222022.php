...
<div class="container-teeti">
    ...
    <div class="form-box">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="form-one active form-step">
                ...
                <div class="grouping">
                    ...
                    <select style="width: 80px; height: 40px;" class="js-profile-country" name="country" id="">
                        <option data-countryCode="GB" value="44" Selected><?=$row->country?></option>
            ...
            <img src="<?=ROOT?>/assets/images/1amw.gif" width="100px" height="200px" style="background: transparent;" alt="">
            <div class="btn-group">
