      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('data-bs-target'), this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-overview" id="profile-overview">Overview</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('data-bs-target'), this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit" id="profile-edit">Edit Profile</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('data-bs-target'), this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings" id="profile-settings">Settings</button>
            </li>

            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('data-bs-target'), this.getAttribute('id'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password" id="profile-change-password">Change Password</button>
            </li>
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade profile-settings pt-3" >
            ...
            <div class="tab-pane fade pt-3 profile-change-password" >
...
<style>
  ...
  <script>
    ...
    var tabid = sessionStorage.getItem("tabid") ? sessionStorage.getItem("tabid"): "profile-overview";
