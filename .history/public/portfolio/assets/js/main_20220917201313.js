...
colorPalette.forEach(color=>{
    color.addEventListener('click',()=>{
        ...
        if(color.classList.contains('color-1')){
            ...
            window.localStorage.setItem("hue", 252);
            window.localStorage.removeItem("hue");
        }else if(color.classList.contains('color-2')){
            
            window.localStorage.setItem("hue", 52);
        }else if(color.classList.contains('color-3')){
          
            window.localStorage.setItem("hue", 352); 
        }else if(color.classList.contains('color-4')){
            
            window.localStorage.setItem("hue", 152);
        }else if(color.classList.contains('color-5')){
          
            window.localStorage.setItem("hue", 202);
        }
        var primaryHue = window.localStorage.getItem("hue");
