      ...
      <div class="card">
        <div class="card-body pt-3">
          ...
          <ul class="nav nav-tabs nav-tabs-bordered">
            ...
            <li class="nav-item">
              <button onclick="set_tab(this.getAttribute('data-bs-target'))" class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-overview" id="profile-overview">Overview</button>
            </li>
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" data-bs-target="#profile-overview" id="profile-overview">
            ...
            <div class="tab-pane fade profile-edit pt-3" data-bs-target="#profile-edit" id="profile-edit">
            ...
            <div class="tab-pane fade pt-3" data-bs-target="#profile-settings" id="profile-settings">
            ...
            <div class="tab-pane fade pt-3" data-bs-target="#profile-change-password" id="profile-change-password">
