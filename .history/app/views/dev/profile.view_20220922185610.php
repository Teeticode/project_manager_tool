        ...
        <form method="post">
            <div class="form-one active form-step">
                ...
                <div class="profile-pic">
                    <img class="img-prev" src="<?= ROOT ?>/dash/assets/img/avatar-1.svg" alt="">
                    <div class="buttons-pic">
                        <i class="bx bx-upload up" onclick="openfileprev()"></i>
                        <input id="prof-pic" onchange="load_image(this.file[0])" class="js-profile-img-input" type="file" name="image" style="display: none;"/>
