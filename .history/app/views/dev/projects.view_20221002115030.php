            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-one active form-step">
                    ...
                    <div>
                        ...
                        <textarea  onclick="textclick()" style="<?= $errors['description']?  "border: 1px solid var(--color-danger); border-radius: 10px; padding:8px; margin-top:10px;" : " padding:8px; margin-top:10px;"?>" id="description" name="description" placeholder="brief description of application"><?= set_value('description')?></textarea>
...
<script>
    ...
    prim_sub.addEventListener('input', (e)=>{
        sub_len.innerHTML = 51 - (prim_sub.value.length);
