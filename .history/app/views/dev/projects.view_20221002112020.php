            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-one active form-step">
                    ...
                    <div>
                        ...
                        <textarea  onclick="textclick()" style="<?= $errors['description']?  "border: 1px solid var(--color-danger); border-radius: 10px; padding:5px; margin-top:10px;" : " padding:5px; margin-top:10px;"?>" id="description" name="description" placeholder="brief description of application"><?= set_value('primary_subject')?></textarea>
...
<script>
    ...
    prim_sub.addEventListener('input', ()=>{
        sub_len.innerHTML = prim_sub.value.length;
        sub_len.style.color = '#ffbb55';
        console.log(prim_sub.value);
        ...
        if(prim_sub.value.length > 0 && prim_sub.value.length <= 50){
            ...
            sub_len.innerHTML = 50;
            sub_len.style.color = '#ff7782';
            prim_sub.style.pointerEvents = 'none';
