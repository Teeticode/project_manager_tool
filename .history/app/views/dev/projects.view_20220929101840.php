                ...
                <tbody>
                    <?php foreach($rows as $row):?>
                        <tr>
                            ...
                            <td class=" remove-mob">
                            <div class="success-teeti" style="background: var(--color-success); color:white; width:50px; height:50px; display:flex; align-items:center; justify-content:center;"><?= esc($row->approved)?></div>    
                            </td>
