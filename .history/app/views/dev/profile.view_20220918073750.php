...
<section class="section profile">
            ...
            <div class="tab-pane fade profile-edit-tab pt-3" id="profile-edit">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="text-center">
                  ...
                  <button type="button" onclick="save_profile()" class="btn btn-danger float-start">Save Changes</button>
  ...
  <div class="popup" id="popup">
    ...
    <h2 id="popup-text">Upload Success!</h2>
    <p>Image was added successfully</p>
    <button onclick="closealert()" type="button">OK</button>
  </div>
  <div class="popup-danger" id="popup-danger">
    <i class="lni lni-cloud-check"></i>
    <h2 id="popup-danger-text">Upload Error!</h2>
...
<style>
  ...
  <script>
    ...
    function save_profile(){
      var img = document.querySelector(".js-profile-img-input");
      var allowed = ['jpg', 'jpeg', 'png', 'gif'];
      console.log(typeof(img.files[0]))
      if(img.files.length > 1){
        if(typeof(img.files[0]) == 'object'){
          var ext = img.files[0].name.split(".").pop();
        }
      
        if(!allowed.includes(ext.toLowerCase())){
          alert("Only this file types are allowed: "+ allowed.toString(","));
          console.log(ext);
          return;
        }
      }
      ...
      ajax.addEventListener('readystatechange', ()=>{
        ...
        if(ajax.readyState == 4){
          if(ajax.status == 200){
            ...
            popup_text.innerHTML = "Profile was updated successfully";
          }else{
