...
<section class="section profile">
                  ...
                  <div class="col-md-8 col-lg-9">
                    ...
                    <div class="pt-2">
                      ...
                      <?php if(!empty($errors['image'])):?>
                        <small class="text-danger js-error-image"><?=$errors['image']?></small>
                      <?php endif;?>
                      <small class="text-danger js-error-image"></small>
                    </div>
                  </div>
                </div>
  ...
  <div class="popup-danger" id="popup-danger">
    ...
    <button onclick="closealertdanger()" type="button">OK</button>
  </div>
</section>
