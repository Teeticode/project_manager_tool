        ...
        <div class="form-box">
            ...
            <form method="post">
                <div class="form-one active form-step">
                    ...
                    <button type="button" style="color: var(--color-white); width:200px; height:50px; padding:14px; background-color: transparent;" class="cust_inp">custom category</button>
