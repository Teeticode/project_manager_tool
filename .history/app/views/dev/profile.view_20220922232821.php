...
<div class="container-teeti">
    ...
    <div class="form-box">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="form-one active form-step">
                ...
                <div class="grouping">
                    ...
                    <select style="width: 80px; height: 40px;" class="js-profile-country" name="country" id="">
                        <option data-countryCode="GB" value="<?=set_value($row->country)?>" Selected></option>
            ...
            <small class="js-error-success text-success"></small>
            <div class="btn-group">
        ...
        function save_profile(e){
            ...
            if(image_added){
                ...
                if(!allowed.includes(ext.toLowerCase())){
                    ...
                    img_err.innerHTML = "This are the only file extensions allowed "+allowed.toString(",");
                    return;
                }
            }
           send_data(obj);
