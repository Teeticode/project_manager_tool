            ...
            <div class="signin-signup">
                ...
                <form method="post" action="" class="sign-in-form">
                    ...
                    <div class="input-field">
                        ...
                        <input value="<?= set_value('username')?>" name="username" type="text" placeholder="Username">
                    </div>
                    <div class="input-field">
                        <i class="lni lni-lock"></i>
                        <input value="<?= set_value('password')?>" name="password" type="password" placeholder="Password">
                    </div>
                    <div class="">
                        
                        <input <?= set_value('terms')? 'checked':''; ?> name="terms" value='1' type="checkbox" placeholder="Password">
                        <small>Agree with terms and condition</small>
                    </div>
                    <input type="submit" name="submitl" value="Login" class="btn solid">
