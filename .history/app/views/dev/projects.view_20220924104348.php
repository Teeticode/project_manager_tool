        ...
        <div class="form-box">
            ...
            <form method="post">
                <div class="form-one active form-step">
                    ...
                    <button type="button" style="color: var(--color-white); border-radius:10px; width:200px; height:50px; padding:14px; background-color: var(--color-primary-variant);" class="cust_inp">custom category</button>
...
<script>
    ...
    cust.addEventListener('click', ()=>{
        ...
        sessionStorage.setItem('input', JSON.parse(input));
