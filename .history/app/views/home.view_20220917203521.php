      ...
      <div class="container">
          ...
          <div class="intro">
              ...
              <div>
                ...
                <?php else:?>
                    <?php if(Auth::is_client()):?>
                        <a href='<?=ROOT?>/client/dashboard/<?=Auth::getuserid()?>' _blank='true' class='hire-me btn btn-default'>Client Portal</a>
                    <?php endif;?>
                    <?php if(Auth::is_dev()):?>
                        <a href='<?=ROOT?>/developer/dashboard/<?=Auth::getuserid()?>' _blank='true' class='hire-me btn btn-default'>Dev Portal</a>
                    <?php endif;?>
                    <?php if(Auth::is_admin()):?>
