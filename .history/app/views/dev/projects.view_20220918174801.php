...
<div class="card mt-5">
  <div class="card-body">
    <h5 class="card-title">Projects <button class="btn btn-primary float-end" style="border-radius: 0 !important;width: 120px; height:40px;"><i class="bi bi-plus"></i> New Project</button></h5>
