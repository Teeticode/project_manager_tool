        ...
        <div class="form-box">
            ...
            <form method="post">
                <div class="form-one active form-step">
                    ...
                    <button type="button" style="color: var(--color-white); width:100px; height:200px; padding:14px; background-color: var(--color-primary);" class="cust_inp">add custom cat</button>
