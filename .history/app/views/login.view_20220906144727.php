            ...
            <form method="post" action="" class="sign-in-form form-m">
               ...
               <?php endif;?>
                <div class="input-field">
                    ...
                    <?php 
                        if(!empty($errors['username'])){
                            echo "<span id='usname-error'>".$errors['username']."</span>";
                        }else{
                            echo "<span id='usname-error'></span>";
                        }
                    ?>
                </div>
                ...
                <div class="input-field">
                    ...
                    <?php 
                        if(!empty($errors['username'])){
                            echo "<span id='password-error'>".$errors['password']."</span>";
                        }else{
                            echo "<span id='password-error'></span>";
                        }
                    ?>
                </div>
