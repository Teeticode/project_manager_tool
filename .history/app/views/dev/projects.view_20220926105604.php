            ...
            <table>
                ...
                <tbody>
                    <?php foreach($rows as $row):?>
                        <tr>
                            <td><img src="<?= ($row->project_image !== null) ? ROOT.'/uploads/'.$row->image : ROOT.'/portfolio/assets/img/4.svg'?>" alt=""></td>
                            <td><?= esc($row->title)?></td>
                            <td class="remove-item"><?= esc($row->projectid)?></td>
                            <td class="remove-item"><?= esc($row->price_id)?></td>
                            <td class="success-teeti remove-mob"><?= esc($row->approved)?></td>
