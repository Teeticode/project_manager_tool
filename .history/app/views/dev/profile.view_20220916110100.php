            ...
            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="github" type="text" class="form-control" id="Github" value="<?=set_value( $row->github,'https://github.com/#')?>">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="linkedin" type="text" class="form-control" id="Linkedin" value="<?=set_value($row->linkedin,'https://linkedin.com/#')?>">
                  </div>
                </div>
