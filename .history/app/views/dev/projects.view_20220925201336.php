            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-one active form-step">
                    ...
                    <div>
                        ...
                        <input type="text" value="<?= set_value('title')?>" id="title" name="title" placeholder="e.g. PHP MVC CRUD APP">
                        ...
                        <select name="services_id" id="">
                            ...
                            <?php if(!empty($services)):?>
                                ...
                                <?php foreach($services as $service):?>
                                    <option <?= set_select('services_id',$service->id)?> value="<?= esc($service->id) ?>"><?= esc($service->service) ?></option>
                                <?php endforeach;?>
                            <?php endif;?>
                        </select>
