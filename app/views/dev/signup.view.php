    ...
    <div class="container">
        <div class="forms-container-signup">
            ...
            <form method="post" action="" class="sign-in-form form-m">
                ...
                <input name="submit-signup" onclick="return validateForm()" type="submit" value="Sign Up" class="btn solid">
        ...
        <div class="panels-container">
            ...
            <div class="content">
                    ...
                    <p>Login to your space and manage your projects much easier.</p>
                    <a href="<?=ROOT?>/developer/login" class="btn transparent" id="sign-in-btn">Sign in</a>
                </div>
