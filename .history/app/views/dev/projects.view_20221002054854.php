            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-one active form-step">
                    ...
                    <div>
                        ...
                        <textarea style="<?= $errors['primary_subject']?  "border: 1px solid var(--color-danger);" : ""?>" id="primary_subject" name="primary_subject" placeholder="brief description of application"><p style="display: absolute; right:0;">20</p><?= set_value('primary_subject')?></textarea>
