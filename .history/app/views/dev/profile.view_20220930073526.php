        ...
        <form method="post" enctype="multipart/form-data">
            <div class="form-one active form-step">
                ...
                <div>
                    ...
                    <input type="text" style="<?= $errors['github'] ?  "border: 1px solid var(--color-danger);" : ""?>" class="js-profile-github" id="github" name="github" value="<?=set_value("write me", $row->github)?>" placeholder="e.g. John">
  ...
  <?php endif;?>
    <script>
        ...
        function display_errors(errors){
            for(key in errors){
                document.querySelector(".js-error-"+key).style.display = "block";
                document.querySelector(".js-error-"+key).innerHTML = errors[key];
                document.querySelector(".js-profile-"+key).style.border = '1px solid text-danger';
            }
           
        }
        function remove_errors(){
            var errs = document.querySelectorAll(".text-danger");
