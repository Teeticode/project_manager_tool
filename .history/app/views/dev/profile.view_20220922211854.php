        ...
        <form method="post">
            <div class="form-one active form-step">
                ...
                <div>
                    ...
                    <textarea name="about" class="js-profile-about" value="<?=set_value(00, $row->about)?>"?></textarea>
                </div>
                <div>
                    <label for="email">Email</label>
                    <input type="email" class="js-profile-email" value="<?=set_value(00, $row->email)?>"?>" placeholder="e.g john@gmail.com">
                </div>
                <div class="birth">
