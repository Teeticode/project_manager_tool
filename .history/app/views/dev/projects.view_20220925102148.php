            ...
            <form method="post">
                <div class="form-one active form-step">
                    ...
                    <div>
                        ...
                        <div class="skills" style="display: flex; align-items:center; justify-content:space-between;">
...
<script>
    ...
    cust.addEventListener('click', ()=>{
        ...
        if(custom_input.querySelectorAll('input').length >= 3){
    ...
    var inputs = custom_input.querySelectorAll('input')
    var btns = custom_input.querySelectorAll('button')
    console.log(btns[1].getAttribute("id"))
    for (let i = 0; i < inputs.length; i++) {
        var ids = btns[i].getAttribute("id")
        btns[i].addEventListener('click', ()=>{
            sessionStorage.removeItem("input"+i)
