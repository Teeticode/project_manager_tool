        ...
        <div class="form-box">
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-one active form-step">
                    ...
                    <div>
                        <label for="title">Title</label>
                        <textarea style="<?= $errors['primary_subject']?  "border: 1px solid var(--color-danger);" : ""?>" id="title" name="primary_subject" placeholder="e.g. PHP MVC CRUD APP"><?= set_value('primary_subject')?></textarea>
