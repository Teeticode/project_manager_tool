            ...
            <div class="signin-signup">
                ...
                <h2 class="title">Sign up</h2>
                    <div class="input-field">
                        ...
                        <input value="<?= set_value('username')?>" type="text" name="username" placeholder="Username">
                        <span class="usname-error">username is required</span>
                    </div>
                    <div class="input-field">
                        <i class="lni lni-envelope"></i>
                        <input value="<?= set_value('email')?>" type="text" name="email" placeholder="Email">
                        <span class="usname-error">email is required</span>
                    </div>
                    <div class="input-field">
                    ...
                    <div class="input-field">
                        ...
                        <input value="<?= set_value('password2')?>" type="password" name="password2" placeholder="Retype Password">
                        <span class="password2-error">Confirm password</span>
                    </div>
                    <div class="">
