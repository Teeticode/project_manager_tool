...
colorPalette.forEach(color=>{
    color.addEventListener('click',()=>{
        ...
        if(color.classList.contains('color-1')){
            ...
            primaryHue = sessionStorage.setItem("hue", 252);
        }else if(color.classList.contains('color-2')){
            
            primaryHue =sessionStorage.setItem("hue", 52);
        }else if(color.classList.contains('color-3')){
          
            primaryHue =sessionStorage.setItem("hue", 352); 
        }else if(color.classList.contains('color-4')){
            
            primaryHue =sessionStorage.setItem("hue", 152);
        }else if(color.classList.contains('color-5')){
          
            primaryHue =sessionStorage.setItem("hue", 202);
        }
        
        console.log(sessionStorage.getItem("hue"));
        console.log(root.style.setProperty('--primary-color-hue', sessionStorage.getItem("hue")));
